...
반드시 key:value의 형태를 띄고 있는 한 쌍
value에 입력될 수 있는 값의 형태는 숫자, 문자만 가능한가? // 배열, 함수도 가능
객체의 특정 key안에 value값으로 입력된 자료의 형태가 함수인 경우에는 별도의 용어를 사용한다

method (=메서드) = 방법 => 우리가 그동안 사용했던 querySelector
querySelector() => 함수

window.document.querySelector()
window 객체 > document 속성 > querySelector 메서드함수
