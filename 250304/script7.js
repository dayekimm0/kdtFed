...
// 처리하고나 하는 데이터가 정상적으로 처리되지 못했을 때,
...
// 2) fullfilled : 어떤 데이터를 정상적으로 처리하게 되면 실행단계 돌입 !! => resolve 라는 함수를 실행한 단계
// 3) rejected : 어떤 데이터를 정상적으로 처리하지 못하게 되면 거절 단계 돌입 ! => reject라는 함수를 실행한 단계
